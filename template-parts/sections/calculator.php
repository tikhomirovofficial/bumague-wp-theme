							...
							<div class="calculator__content">
								...
								<div class="calculator__tab" data-calc-tab="2">
									...
									<div class="calculator__options">
										...
										?>
										<label class="calculator__option">
											<input class="visually-hidden" type="radio" name="quantity" value="custom"
												required>
											<span class="calculator__option-checkbox"></span>
											<div class="calculator__option-content">
												<span class="calculator__option-name">Свой вариант</span>
									...
									<div class="calculator__form">
										...
										<div class="calculator__form-field field field--select field--filled">
											...
											<div class="field__select-dropdown">
												<div class="field__select-option" data-value="1">Первый вариант</div>
												<div class="field__select-option" data-value="2">Второй вариант</div>
												<div class="field__select-option" data-value="3">Третий вариант</div>
												<div class="field__select-option" data-value="4">Четвёртый вариант</div>
											</div>
											<select id="request-communication" name="communication"
												class="field__select-real" required>
												<option value="">Выберите вариант</option>
												<option value="1">Первый вариант</option>
												<option value="2">Второй вариант</option>
												<option value="3">Третий вариант</option>
												<option value="4">Четвёртый вариант</option>
											</select>
										</div>

										<label for="request-comment" class="calculator__form-field field">
											<textarea id="request-comment" name="comment" placeholder="Комментарий"
												type="text" class="field__input"></textarea>
										</label>

										<div class="field field--upload">
											<input type="file" id="request-files"
												class="field__upload-input visually-hidden" multiple
