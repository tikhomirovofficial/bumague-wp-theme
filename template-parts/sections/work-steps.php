<?php
/**
 * Общая секция "Этапы работы" (переиспользуемая)
 */
?>
...
<section class="section section--decoration-cells">
        <header class="section__header container">
            <div class="section__header-info">
                <h2 class="section__title">
                   <?php the_field('work_steps_title', 'option'); ?>
                </h2>
            </div>
        </header>
        <div class="section__body">
            <div class="work-steps container">
                ...
                <?php
                $work_steps = get_field('ws', 'option'); // Получаем весь массив
                if ($work_steps && is_array($work_steps)): ?>
                    <ul class="work-steps__list">
                        <?php foreach ($work_steps as $index => $step): ?>
                            <?php if (isset($step['ws_item'])): ?>
                                <li class="work-steps__item">
                                    <?php if ($step['ws_item']['ws_item_trigger']): ?>
                                        <button data-modal="quick-request-window" class="work-step work-step--highlight">
                                            <div class="work-step__number"></div>
                                            <h3 class="work-step__title"><?php echo esc_html($step['ws_item']['ws_item_title']); ?></h3>
                                            <h3 class="work-step__title work-step__title--active">Оформить заявку</h3>
