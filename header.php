    ...
    <div class="header__inner container">
        <div class="header__top">
            ...
            <div class="header__info header__top-contacts">
                <a href="tel:<?php echo wp_normalize_phone(get_field("c_phone", "option")); ?>" class="header__info-accent">
                    <?php the_field("c_phone", "option"); ?>
                </a>
                <a href="mailto:<?php the_field("c_email", "option"); ?>" class="header__info-bottom"><?php the_field("c_email", "option"); ?></a>
            </div>
        </div>
        <div id="header-main" class="header__main">
                    ...
                    <ul class="header__nav-list">
                        ...
                        ?>
                            <li class="header__nav-item">
                                <a href="<?php echo esc_url($link); ?>" class="header__nav-link">
                                    <?php echo esc_html($text); ?>
                                </a>
                            </li>
                        <?php endwhile; ?>
            ...
            <div class="header__contacts">
                <a href="tel:<?php echo wp_normalize_phone(get_field("c_phone", "option")); ?>" class="header__contacts-link">
                    <?php the_field("c_phone", "option"); ?>
                </a>
